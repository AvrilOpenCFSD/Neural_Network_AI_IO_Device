...
// registers.
        private OpenAvrilNNAI_OpenAvrilConcurrency_IO_Praise_Nth.Linear_NeuralPath[] _List_Of_Linear_NeuralPath;
...
// public.
        ...
        {
            Set_List_Of_Linear_NeuralPath(new OpenAvrilNNAI_OpenAvrilConcurrency_IO_Praise_Nth.Linear_NeuralPath[Get_NumberOfInputs()]);
            while (Get_List_Of_Linear_NeuralPath() == null) { }
            for (byte index = 0; index < Get_NumberOfInputs(); index++)
            {
                Set_Item_On_List_Of_Linear_NeuralPath(index, new OpenAvrilNNAI_OpenAvrilConcurrency_IO_Praise_Nth.Linear_NeuralPath());
                while (Get_Item_On_List_Of_Linear_NeuralPath(index) == null) { }
            }
        }
        public void Run_All_Neural_Path_Calculation(OpenAvrilNNAI_OpenAvrilConcurrency_IO_Praise_Nth.MachineAI objNNI, byte outputID, byte hiddenLayerID, byte nodeID, byte numberOfInputsForNode)
        {
            double sum_Bias = 0.0;
    ...
    // get.
        public OpenAvrilNNAI_OpenAvrilConcurrency_IO_Praise_Nth.Linear_NeuralPath Get_Item_On_List_Of_Linear_NeuralPath(byte inputID)
        {
            return _List_Of_Linear_NeuralPath[inputID];
        }
        public OpenAvrilNNAI_OpenAvrilConcurrency_IO_Praise_Nth.Linear_NeuralPath[] Get_List_Of_Linear_NeuralPath()
        {
    ...
    // set.
        public void Set_Item_On_List_Of_Linear_NeuralPath(byte inputID, OpenAvrilNNAI_OpenAvrilConcurrency_IO_Praise_Nth.Linear_NeuralPath newLinearPath)
        {
...
// private.
    ...
    // get.
    // set.
        private void Set_List_Of_Linear_NeuralPath(OpenAvrilNNAI_OpenAvrilConcurrency_IO_Praise_Nth.Linear_NeuralPath[] newListOfLinearNeuralPath)
        {
